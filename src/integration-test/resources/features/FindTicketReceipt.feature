...
Feature: Search with ticket number should return ticket receipt
  ...
  Scenario Outline: One ancillary bought same date as ticket (2 FOPs), pax amt = ticket FOP amt + Ancillary FOP amt
    ...
    Examples:
      ...
      | One ancillary bought same date as ticket (2 FOPs), pax amt = ticket FOP amt + Ancillary FOP amt | 0012120193738 | NEWLINHAUS | 2        | 245.20               | 35.00         | 2020-03-07         | CCB               | 5051                        | 617069698    | 2020-03-07      | 35.00                     | 35.00                     | 0.00                    |
  ...
  Scenario Outline: Two ancillaries bought with ticket (3 FOPs), pax amt = ticket FOP amt + Ancillary FOP amts
    ...
    Examples:
      ...
      | 2ancillaries | 0012132820896 | ADAMS    | 3        | 640.51               | 619785952       | 2020-07-16         | 090               | MAIN CABIN EXTRA (PHL - LAX) | 44.31                        | USD                        | 44.31                        | USD                        | 0.00                       | 620518471       | 2020-08-13         | 099               | MSR-OTHER NON TAXABLE (PHL - LAX) | 100.00                       | USD                        | 100.00                       | USD                        | 0.00                       |
