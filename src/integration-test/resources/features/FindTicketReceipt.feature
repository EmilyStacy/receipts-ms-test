...
Feature: Search with ticket number should return ticket receipt
  ...
  Scenario Outline: Happy path scenario for receipt header
    ...
    Then I get a successful response with origin airport "<originAirport>", destinationAirport "<destinationAirport>" and pnr "<pnr>" and advantageNumber "<advantageNumber>"

    Examples:
      | scenario                                        | ticketNumber   | lastName | firstName | departureDate  | originAirport | destinationAirport | pnr    | advantageNumber |
      | One way with over night connection              | 0012336961822  | SOUTHERN | FLAGSHIP  | 2019-05-20     | GRU           | LHR                | GZNJJP | 270RFY8         |
      | One way non-stop                                | 0012337074732  | BRAVO    | ALPHA     | 2019-06-26     | LGA           | DTW                | DNSBYR | 273RFY0         |
  ...
  Scenario Outline: Ticket receipt details for different types of itineraries
    ...
    Examples:
      ...
      | Round trip with 2 stops each way                  | 0012371651094 | SMITH            | JOHN        | 2019-10-26    | EAXKUC | MQ4063 leaving TYR(Tyler, TX) to DFW(Dallas/Fort Worth, TX) on 2019-10-26 at 06:45:00 and arriving 07:48:00 in class OWBVZNB5. AA2695 leaving DFW(Dallas/Fort Worth, TX) to DCA(Washington, DC) on 2019-10-26 at 08:59:00 and arriving 12:53:00 in class OWBVZNB5. AA2119 leaving DCA(Washington, DC) to BOS(Boston, MA) on 2019-10-26 at 13:30:00 and arriving 15:10:00 in class OWBVZNB5. | AA2265 leaving BOS(Boston, MA) to ORD(Chicago, IL) on 2019-11-05 at 06:00:00 and arriving 08:01:00 in class QVAIXSB5. AA1217 leaving ORD(Chicago, IL) to DFW(Dallas/Fort Worth, TX) on 2019-11-05 at 09:00:00 and arriving 11:37:00 in class QVAIXSB5. MQ3674 leaving DFW(Dallas/Fort Worth, TX) to TYR(Tyler, TX) on 2019-11-05 at 12:36:00 and arriving 12:50:00 in class QVAIXSB5.  |
      | Round trip with 2 stops open jaw                  | 0012371651104 | FRANKLIN         | MARK        | 2019-11-05    | WGUBWQ | AA2265 leaving BOS(Boston, MA) to ORD(Chicago, IL) on 2019-11-05 at 06:00:00 and arriving 08:01:00 in class QVAIXSB5. AA1217 leaving ORD(Chicago, IL) to DFW(Dallas/Fort Worth, TX) on 2019-11-05 at 09:00:00 and arriving 11:37:00 in class QVAIXSB5. MQ3674 leaving DFW(Dallas/Fort Worth, TX) to TYR(Tyler, TX) on 2019-11-05 at 12:36:00 and arriving 12:50:00 in class QVAIXSB5. | MQ3983 leaving GGG(Gladewater/Kilgore/Longview, TX) to DFW(Dallas/Fort Worth, TX) on 2019-11-15 at 06:35:00 and arriving 07:35:00 in class OWBVZNB5. AA2695 leaving DFW(Dallas/Fort Worth, TX) to DCA(Washington, DC) on 2019-11-15 at 09:00:00 and arriving 12:53:00 in class OWBVZNB5. AA2119 leaving DCA(Washington, DC) to BOS(Boston, MA) on 2019-11-15 at 13:30:00 and arriving 15:00:00 in class OWBVZNB5.  |
      | Round trip with 3 stops with different fair basis | 0012371651123 | SANDERSON        | ADAM        | 2019-12-15    | ZDRTNN | AA298 leaving HNL(Honolulu, HI) to LAX(Los Angeles, CA) on 2019-12-15 at 22:30:00 and arriving 05:55:00 in class OVAKWSBH. AA2437 leaving LAX(Los Angeles, CA) to DFW(Dallas/Fort Worth, TX) on 2019-12-16 at 07:00:00 and arriving 12:03:00 in class Q7AKZNB3. AA2839 leaving DFW(Dallas/Fort Worth, TX) to ORD(Chicago, IL) on 2019-12-16 at 13:27:00 and arriving 15:51:00 in class Q7AKZNB3. MQ3858 leaving ORD(Chicago, IL) to CMI(Champaign, IL) on 2019-12-16 at 17:10:00 and arriving 17:41:00 in class NVBHZNB3. | MQ3577 leaving CMI(Champaign, IL) to ORD(Chicago, IL) on 2020-02-12 at 06:33:00 and arriving 07:36:00 in class NVBHZNB3. AA2428 leaving ORD(Chicago, IL) to DFW(Dallas/Fort Worth, TX) on 2020-02-12 at 08:25:00 and arriving 10:48:00 in class Q7AKZNB3. AA2811 leaving DFW(Dallas/Fort Worth, TX) to LAX(Los Angeles, CA) on 2020-02-12 at 11:45:00 and arriving 13:05:00 in class Q7AKZNB3. AA143 leaving LAX(Los Angeles, CA) to HNL(Honolulu, HI) on 2020-02-12 at 14:00:00 and arriving 18:20:00 in class OVAKZSBH. |
