...
public class ReceiptsMSDomainTest {
    ...
    public void testPassengerDetailToString() throws ParseException {
        TicketReceipt ticketReceipt = getTicketReceipt();
        Assert.assertEquals(
                "ticketNumber=2371661425, firstName=SIMON, lastName=TEST, advantageNumber=XYZ1234, passengerTotalAmount=123.45, showPassangerTotal=false, fareTaxesFees=FareTaxesFees{baseFareAmount='77674', baseFareCurrencyCode='USD2', totalFareAmount='84930', taxFareAmount='7256', taxes='[]'}, loyaltyOwnerCode=AA, formOfPayments=[FormOfPayment{fopIssueDate=2019-03-14, fopTypeCode='CCBA', fopTypeDescription='null', fopAccountNumberLast4='0006', fopAmount='225295', fopCurrencyCode='USD2', ancillaries='[Anclry{anclryDocNbr='654200213', anclryIssueDate='2019-11-07', anclryProdCode='090', anclryProdName='MAIN CABIN EXTRA (DFW - BDL)', anclryPriceCurrencyAmount='72.91', anclryPriceCurrencyCode='USD', anclrySalesCurrencyAmount='78.38', anclrySalesCurrencyCode='USD', anclryTaxCurrencyAmount='5.47'}]'}]",
