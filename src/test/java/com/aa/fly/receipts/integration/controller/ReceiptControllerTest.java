...
public class ReceiptControllerTest {
    ...
    public void findReceipt_byTicketNumber() throws Exception {
        ...
        RequestBuilder request = MockMvcRequestBuilders.post("/api/receipt").accept(MediaType.APPLICATION_JSON)
                .contentType(MediaType.APPLICATION_JSON).content(searchCriteriaJson());
